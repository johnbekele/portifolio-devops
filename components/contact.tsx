...
export function Contact({ email, githubUrl, linkedinUrl, blurb, name }: ContactProps) {
  ...
  return (
    <div>
      ...
      <div className="mt-12 pt-8 border-t border-border">
        <h3 className="text-sm font-medium text-foreground mb-4">Or find me on</h3>
      ...
      <footer className="mt-16 pt-8 border-t border-border text-sm text-muted-foreground">
        ...
        <p className="mt-2">
          &copy; {new Date().getFullYear()} {name || "Yohans Bekele"}. All rights reserved.
        </p>
      </footer>
    </div>
  )
